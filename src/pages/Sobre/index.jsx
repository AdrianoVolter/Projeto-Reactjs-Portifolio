        ...
        <section className={styles.sobre}> 
            <div className={styles.bio}>
                ...
                <div className={styles.textos}>
                      <h2>Sobre</h2>
                      <p>Olá, sou <span>Adriano Volter</span>, tenho 38 anos<br /> Sou estudante de <strong>Curso Dev FullStack</strong> no <strong>Senai/SC </strong>.
                        </p>
                        <p>Atualmente estou no modulo 2 do curso <br /> 
                        </p>
